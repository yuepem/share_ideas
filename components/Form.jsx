  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
         {type} and share amazing ideas with the world, and let your imagination run wild with any prompts.
      </p>
      ...
      <form className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
        ...
        <label >
          <span className="font-satoshi font-semibold text-base text-gray-700 ">
            Tag
            <span className="font-normal mx-2">(#product, #webdevelopment, #idea, #note)</span>
          </span>
